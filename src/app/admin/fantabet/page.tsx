...
export default async function AdminFantaBetPage() {
  ...
  return <main className="mx-auto w-full max-w-7xl px-3 py-4 sm:px-6 sm:py-9"><AdminHeader eyebrow="Gestione FantaBet" title="FantaBet" username={access.username} href="/admin/importazioni" linkLabel="Vai ad importazioni" /><AdminFantaBetClient initial={data} /></main>;
}
