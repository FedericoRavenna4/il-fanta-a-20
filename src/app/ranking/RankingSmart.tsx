  ...
  return (
    <>
      <div className="grid gap-3 sm:gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        {podio[0]?.team && (
          <article className="relative overflow-hidden rounded-[2rem] border border-amber-300/70 bg-[linear-gradient(135deg,#6f4b0d_0%,#c99a34_34%,#f4dda0_57%,#9a6815_100%)] p-3 text-white shadow-[0_20px_52px_rgba(120,78,12,.22)] sm:p-7">
            <div className="absolute inset-0 bg-[linear-gradient(115deg,transparent_18%,rgba(255,255,255,.22)_42%,transparent_62%)] opacity-70" />
