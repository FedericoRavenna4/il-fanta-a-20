...
export default function AuthForm({ action, fields, submitLabel, footer }: { action: (state: AccountActionState, formData: FormData) => Promise<AccountActionState>; fields: Field[]; submitLabel: string; footer?: { text: string; href: string; label: string } }) {
