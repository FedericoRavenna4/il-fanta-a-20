...
export const recordPaths = [
  {
    eyebrow: "La gerarchia delle societ\u00e0",
    title: "Il Ranking Storico",
...
export default function RecordPathCards() {
  return <div className="grid gap-3 sm:gap-5 md:grid-cols-2">
    {recordPaths.map((item) => (
